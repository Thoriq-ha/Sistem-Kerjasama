<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="telp" type="text" class="mt-1 block w-full" wire:model.defer="state.telp" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="nama_lembaga" type="text" class="mt-1 block w-full"
                wire:model.defer="state.nama_lembaga" />
            <x-jet-input-error for="nama_lembaga" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="keterangan" value="Keterangan" />
            <x-jet-input id="keterangan" type="text" class="mt-1 block w-full" wire:model.defer="state.keterangan" />
